    ...
    <div className="w-full max-w-2xl mx-auto px-4">
      ...
      >
        ...
        <div className="relative rounded-2xl border border-slate-200/60 bg-white shadow-xl shadow-slate-200/50 overflow-hidden">
            ...
            {isDetailedMode && (
              <div className="mt-4">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full px-4 py-3 text-sm text-slate-700 bg-slate-50 rounded-xl border border-slate-200/60 focus:border-slate-300 focus:bg-white focus:shadow-sm outline-none transition-all resize-none"
          ...
          {/* Criteria Section - Editable in detailed mode */}
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                  ...
                  <svg className={`w-4 h-4 ${isDetailedMode ? "text-blue-600" : "text-amber-600"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                {isDetailedMode ? (
                  <>
                    {editedCriteria.map((crit, index) => (
                      ...
                      >
                        <div className="w-6 h-6 rounded-lg bg-blue-50 border border-blue-200/50 flex items-center justify-center flex-shrink-0">
                        ...
                        <input
                          ...
                          className="flex-1 px-3 py-2 text-sm text-slate-700 bg-slate-50 rounded-lg border border-slate-200/60 focus:border-blue-300 focus:bg-white focus:shadow-sm outline-none transition-all"
                    ...
                    {editedCriteria.length < 10 && (
                      <button
                        ...
                        className="mt-2 w-full py-2.5 text-sm font-medium text-slate-400 hover:text-slate-600 border-2 border-dashed border-slate-200 hover:border-slate-300 rounded-lg transition-all hover:bg-slate-50/50 group"
                      >
                        <span className="flex items-center justify-center gap-2">
        ...
        {isDetailedMode ? (
          <>
            ...
            <div className="flex items-center gap-2 px-1 mb-2">
              ...
              <span className="text-sm font-medium text-blue-600">Detaillierter Bearbeitungsmodus</span>
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-sm font-medium text-slate-500 hover:text-slate-700 hover:bg-slate-100 transition-all"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
